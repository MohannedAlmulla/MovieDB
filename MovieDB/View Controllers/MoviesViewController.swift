...
class MoviesViewController: UIViewController, UITableViewDataSource, UITableViewDelegate {
    ...
    */
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell{
        ...
        cell.overviewLable.text = movie[overview] as! String //linking the overview space in the app to the database movie overview
        cell.posterLabel.setImageWithUrl(imageUrl!) //linking the poster space in the app to the database movie poster
